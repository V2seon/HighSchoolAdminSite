...
/**
 * QGradeType1DataEntity is a Querydsl query type for GradeType1DataEntity
 */
@Generated("com.querydsl.codegen.DefaultEntitySerializer")
public class QGradeType1DataEntity extends EntityPathBase<GradeType1DataEntity> {

    private static final long serialVersionUID = -1897021095L;

    public static final QGradeType1DataEntity gradeType1DataEntity = new QGradeType1DataEntity("gradeType1DataEntity");
    ...
    public final StringPath FirstPlusName = createString("FirstPlusName");

    public final StringPath FirstPlusType1 = createString("FirstPlusType1");

    public final StringPath FirstPlusType2 = createString("FirstPlusType2");

    public final StringPath FirstPlusType3 = createString("FirstPlusType3");
    ...
    public final StringPath SecondPlusName = createString("SecondPlusName");

    public final StringPath SecondPlusType1 = createString("SecondPlusType1");

    public final StringPath SecondPlusType2 = createString("SecondPlusType2");

    public final StringPath SecondPlusType3 = createString("SecondPlusType3");
    ...
    public final StringPath ThirdPlusName = createString("ThirdPlusName");

    public final StringPath ThirdPlusType1 = createString("ThirdPlusType1");

    public final StringPath ThirdPlusType2 = createString("ThirdPlusType2");

    public final StringPath ThirdPlusType3 = createString("ThirdPlusType3");
    ...
    public QGradeType1DataEntity(String variable) {
        super(GradeType1DataEntity.class, forVariable(variable));
    }

    public QGradeType1DataEntity(Path<? extends GradeType1DataEntity> path) {
        super(path.getType(), path.getMetadata());
    }

    public QGradeType1DataEntity(PathMetadata metadata) {
        super(GradeType1DataEntity.class, metadata);
    }
