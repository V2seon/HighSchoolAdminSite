...
console.log(aseq);
        ...
        $.ajax({
            ...
            type     : "GET",
            success : function(result) {
                    window.open('/daa/grade', 'window_name','width=815, height=1250, location=no, status=no, scrollbars=yes');
            },
            error : function(request,status,error){
                $('#load').hide();
                swal({
